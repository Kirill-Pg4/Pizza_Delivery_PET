...
object database_seed {
    ...
    var standardPositionPizza = mutableListOf<Dish>(
        ...
        Dish(11,
            DishesImg = R.drawable.westukranian_pizza,
            DishesName = "West Ukrainian Pizza",
            DishesShortDescribe = "Get a taste of Western Ukraine with this hearty pizza. It has a thick crust topped with succulent roasted pork, cabbage, potatoes, onions, and melted cheese.",
            DishesProp = "27 minutes",
            DishPrice = 14.99f,
            DishGram = "400 grams"
        )
    )
    var standardPositionDrinks = mutableListOf<Dish>(
        Dish(1, R.drawable.beer_drink, "Beer", "An alcoholic beverage made from fermented grains, typically barley, flavored with hops. It is a popular choice to accompany pizza.", "Instant", 5.99f, "330ml"),
        Dish(2, R.drawable.cola_drink, "Cola", "A carbonated soft drink containing caffeine and sweeteners. It provides a refreshing and fizzy taste that complements the flavors of pizza.", "Instant", 1.99f, "500ml"),
        Dish(3, R.drawable.energy_drink, "Energy Drink", "A beverage containing stimulant substances, such as caffeine and taurine, designed to provide a boost of energy. It pairs well with pizza, especially during long nights.", "Instant", 2.49f, "250ml"),
        Dish(4, R.drawable.fanta_drink, "Fanta", "A fruity carbonated soft drink available in various flavors. It offers a vibrant and refreshing taste that enhances the enjoyment of pizza.", "Instant", 1.99f, "500ml"),
        Dish(5, R.drawable.kvas_drink, "Kvas", "A traditional fermented beverage made from rye bread. It has a slightly sweet and tangy flavor, making it an interesting choice to complement pizza.", "Instant", 2.99f, "330ml"),
        Dish(6, R.drawable.lemonade_drink, "Lemonade", "A sweet and tangy non-alcoholic beverage made from lemon juice, sugar, and water. It provides a zesty and refreshing taste that goes well with pizza.", "Instant", 2.49f, "500ml"),
        Dish(7, R.drawable.mohito_drink, "Mojito", "A classic cocktail made with white rum, lime juice, sugar, soda water, and mint leaves. Its minty and citrusy flavors offer a delightful contrast to the flavors of pizza.", "5 minutes", 7.99f, "250ml"),
        Dish(8, R.drawable.pepsi_drink, "Pepsi", "A carbonated cola soft drink known for its distinct flavor. It provides a great companion to pizza, with its sweet and slightly tangy taste.", "Instant", 1.99f, "500ml"),
        Dish(9, R.drawable.schweppes_drink, "Schweppes", "A range of carbonated beverages available in various flavors, including tonic water, ginger ale, and club soda. They offer a fizzy and versatile option to pair with pizza.", "Instant", 1.99f, "500ml"),
        Dish(10, R.drawable.sprite_drink, "Sprite", "A lemon-lime flavored carbonated soft drink known for its crisp and clean taste. It provides a refreshing and citrusy complement to the flavors of pizza.", "Instant", 1.99f, "500ml")
        )
    var OrderLi = mutableListOf<Dish>()
